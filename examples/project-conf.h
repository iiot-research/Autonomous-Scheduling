...
#define MAX_NODE_NUM 70 // maximum number of nodes

#define SERVER_REPLY          1  
#define WITH_COMPOWER   1 
#define SERVER_WITH_COMPOWER  1
...
#define RPL_CONF_DEFAULT_LIFETIME        4
...
#define NBR_TABLE_CONF_MAX_NEIGHBORS MAX_NODE_NUM // modified. original:10
...
#define ORCHESTRA_CONF_UNICAST_PERIOD 201 
...
#ifndef PERIOD 
#define PERIOD 10 //upstream/downstream send interval //15 (seq20)   30 (seq40)   60 (seq80)   90 (seq120)
#define PERIOD_SERVER PERIOD*1 //downstream/downstream send interval //15 (seq20)   30 (seq40)   60 (seq80)   90 (seq120)
#endif
...
#define START_AFTER_PERIOD (9 * 60 * (CLOCK_SECOND)) //ksh.. RPL construction.. no udp packet during this time.. 
...
#define IMP_METHOD1  0
#define IMP_METHOD2  0
#define IMP_METHOD3  1
#define IMP_METHOD4  0
...
#define ECHO_DOWNSTREAM_ENABLED 0 // 1:echo, 0:not echo (independent)

#if !ECHO_DOWNSTREAM_ENABLED
#define DO_SEQ_SEND_WITH_INTERVAL 1 // 1:sequential send with interval, 0:sequential send without interval (bursty)
#endif
...
/**********************************************************************/
// TSCH backoff window setting modification........................//
//#define TSCH_CONF_MAC_MIN_BE 1//original: 1
#define TSCH_CONF_MAC_MAX_BE 3 //original: 7

// RPL modification..............................................//
#define RPL_MRHOF_CONF_SQUARED_ETX 0 // mrhof using squared etx.// original value:0


#define RPL_CONF_WITH_PROBING 1 // original: 1
//#define RPL_CONF_PROBING_INTERVAL (60 * CLOCK_SECOND) // original: (120 * CLOCK_SECOND)
//#define RPL_PROBING_SEND_FUNC(instance, addr) dis_output((addr)) // original: dio_output



#define TSCH_SCHEDULE_CONF_MAX_LINKS MAX_NODE_NUM*2 // as escalator..


#define RPL_CONF_DIS_INTERVAL 10 // original: 60s
...
#define IMP_CALLBACK_PACKET_SELECTION imp_callback_packet_selection //xia. imp packet selection
#define SPE_CALLBACK_PACKET_SELECTION spe_callback_packet_selection //xia. imp packet selection
...
#define ORCHESTRA_ONE_CHANNEL_OFFSET 1 // 1: only one channel offset for unicast slotframe , 0: multiple channel offset for unicast slotframe 



#if WITH_ALICE || ORCHESTRA_CONF_UNICAST_SENDER_BASED //Orchestra SB
#define RPL_CONF_WITH_DAO_ACK 1 // enable dao ack. original: 0.
#define RPL_CONF_RPL_REPAIR_ON_DAO_NACK 1 // enable local repair. quickly find another parent. original: 0
#else //Orchestra RB
#define RPL_CONF_WITH_DAO_ACK 0 //  original: 0.
...
//#undef TSCH_LOG_CONF_LEVEL  // undef
//#define TSCH_LOG_CONF_LEVEL 0 // undef
#endif /* WITH_SECURITY */
